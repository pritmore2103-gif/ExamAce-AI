        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              {planId && (
                <span className="w-fit text-xs px-3 py-2 rounded-full bg-emerald-900/30 border border-emerald-700 text-emerald-400">
                  ● Plan Saved
                </span>
              )}
            </div>
          ...
          {successMessage && (
            <div className="mb-6 bg-emerald-900/30 border border-emerald-700 text-emerald-300 p-4 rounded-xl">
              {successMessage}
            </div>
          )}
            ...
            <div className="space-y-4">
              {subjects.map(
                (subject, index) => (
                  <div
                    key={subject.name}
                    className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-800 p-4 rounded-xl"
                  >
          ...
          <div className="flex flex-wrap gap-3 mb-8">
            ...
            {planId && (
              <button
                ...
                className="bg-red-600/20 hover:bg-red-600/30 border border-red-700 text-red-300 px-6 py-3 rounded-xl font-semibold transition"
              >
                {deletingPlan
                  ? "Deleting..."
                  : "🗑️ Delete Plan"}
            ...
            planCreated && (
              <section className="bg-slate-900 rounded-2xl p-6 md:p-8 mb-8">
                ...
                <button
                  ...
                  onClick={addTask}
                  disabled={addingTask}
                  className="mt-5 bg-emerald-600 hover:bg-emerald-700 disabled:bg-slate-700 px-6 py-3 rounded-xl font-semibold transition"
                >
                  {addingTask
                    ? "Adding..."
                    : "➕ Add Task"}
